  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'admin/loans',
        loadComponent: () =>
          import('./features/admin/active-loans.component').then((m) => m.ActiveLoansComponent)
      },
      {
        path: 'admin/returns',
        loadComponent: () =>
          import('./features/admin/accessory-returns.component').then(
            (m) => m.AccessoryReturnsComponent
          )
      },
      {
        path: 'orders/new',
